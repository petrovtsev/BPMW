...
<div class="pages">
    ...
    <div class="content-account">
        ...
        <form>
            ...
            <table class="data-table-account">
                ...
                <tr>
                    ...
                    <td><input class="input_text" value="${userModel.activeUser.email}"/></td>
        ...
        <div class="side-button">
            ...
            <button id="myBtn" class="little_button">Delete</button>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="userController" method="post">
                            <br>
                        <div class="side-button">
                            <input class="input_text" type="password" id="password" name="password"><br><br>
                            <button class="little_button" type="submit">Delete</button>
                            <button class="little_button" type="button" name="back" onclick="history.back()">Back</button>
                        </div>
                    </form>
                </div>
